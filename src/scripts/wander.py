...
class avoidance:
    ...
    def move(self):
        ...
        critical = 0.5              #in real world make it 0.3 | Gazebo 0.2
        ...
        while line_detection==0:
            ...
            diff_ctitical = self.front_l_cr-self.front_r_cr     #used in regular conditions
            ...
            print('front_l_cr:', self.front_l_cr)
            print('front_r_cr:', self.front_r_cr)
            self.velocity_publisher.publish(vel_msg)
            self.rate.sleep()
